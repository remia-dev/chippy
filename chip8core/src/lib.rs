...
// Class that will manage the emulator
pub struct Emu {
    // Program Counter
    pc: u16,
    ram: [u8; RAM_SIZE],
    screen: [bool; SCREEN_WIDTH * SCREEN_HEIGHT],
    // V registers deals with Opcodes (font sizes in this case)
    v_reg: [u8; NUM_REGS],
    // I registers
    i_reg: u16,
    // Stack pointer
...
impl Emu {
    ...
    // push adds the given 16 bit value to the pointed stack pointer
    ...
    // Grab the opcodes we are about to execute
       fn fetch(&mut self) -> u16 {
        let higher_byte: u16 = self.ram[self.pc as usize] as u16;
        let lower_byte: u16 = self.ram[self.pc as usize] as u16;
    ...
    fn execute(&mut self, op: u16) {
        ...
        match (digit1, digit2, digit3, digit4) {
            ...
            // Delay Timer
            // VX = DT
            // Timer ticks down every frame until reaching zero
            // stores current value into one of the v registers to use
            (0xF, _, _0, 7) => {
                let x = digit2 as usize;
            ...
            (0xF, _, 3, 3) => {
                ...
                // Fetch hundreds digit by dividing by 100
            ...
            // unimplemented causes the program to panic
